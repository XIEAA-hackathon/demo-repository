...
os.environ["ADMIN_EMAIL"] = "system-admin@test.example"
os.environ["ADMIN_PASSWORD"] = secrets.token_urlsafe(24)
os.environ["ADMIN_NAME"] = "System Admin"
...
os.environ.setdefault("LAB_ADMIN_PASSWORD", secrets.token_urlsafe(24))
...
from app.api import auth, team, problem_statements, auction, wildcard, participant, admin, websockets, rounds, operations, judging, management, labs
