...
export const participantStageRoutes: readonly ParticipantStageRoute[] = [
  ...
  { state: 'WILDCARD_PREVIEW', label: 'Wildcard preview', path: '/participant/wildcard/preview' },
  { state: 'WILDCARD_BIDDING', label: 'Wildcard bidding', path: '/participant/wildcard/bid' },
